...
if args.plot_phred:
    ...
    '''
    # This part is for drawing, not including this part to ignore drawing
    ...
    pairs = {'Index': x, 'Score': y}

    log_df = pd.DataFrame.from_dict(pairs)

    log_df.to_csv(str(args.outfile_name) + '.csv')
